...
/**
 * @brief Validates the core simulation parameters
 * for the dining philosophers problem
 * 
 * This function performs comprehensive validation of
 * the essential simulation parameters
 * to ensure they meet the requirements for a valid
 * dining philosophers simulation.
 * It checks for proper ranges, minimum timing
 * constraints, and maximum value limits.
 * 
 * Validation rules:
 ...
 * @param die_time Maximum time (in milliseconds)
 * a philosopher can go without eating
 ...
 * 
 * @note This function prints specific error messages
 * to stdout when validation fails
 * @note The 60ms minimum for time values ensures the
 * simulation runs at a reasonable pace
 */
 ...
 * arguments provided to the program, converts
 * them from strings to appropriate numerical
 * values, and validates their correctness.
 ...
 * - input[4]: [optional]
 * number_of_times_each_philosopher_must_eat (≥1, ≤INT_MAX)
 * 
