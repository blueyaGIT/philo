...
/*   Updated: 2025/06/01 14:41:08 by dalbano          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Creates and initializes a pthread mutex with default attributes
 * 
 ...
 * - Setting the mutex pointer to NULL on failure (though this may not be effective)
 ...
 * @note The caller should check the return value and handle failures appropriately
